    ...
    <div className="flex flex-col md:flex-row gap-8 w-full max-w-6xl mx-auto py-8">
      ...
      >
        <div>
          ...
          <div className="border-2 border-dashed border-zinc-300 rounded-lg h-36 flex flex-col items-center justify-center bg-zinc-50 mb-2">
            {preview ? (
      ...
      <div className="flex-1 bg-white rounded-xl shadow p-6 flex flex-col gap-4 min-w-[320px]">
        ...
        <div className="text-xs text-zinc-500">Listed just now<br />{location && `in ${location}`}</div>
